...
sizes.
All of these determinations are purely combinatorial.  Equation~\eqref{eq:QN} yields a ground-state \lw{why ground state ? you have not make physical connection yet} entropy
per queen
...
Section~\ref{sec:conclusions} concludes. \lw{with discussions on ...}
...
the corner transfer matrix renormalization group (CTMRG) can
