...
formalism~\cite{Liu2021}. \lw{is the right reference here ?}
...
are $A_{00}(0) = A_{11}(0) = 1$  \lw{use superscripts rather than () } (empty site: signal pass-through)
...
using matrix product operator methods~\cite{Liu2021} \lw{may not be the right 
ref, cite Tao Xiang's book} 
, with a
...
\lw{draw a schematic figure to illustrative the contraction of tensor network 
for counting (indicate the boundary conditions)} 
