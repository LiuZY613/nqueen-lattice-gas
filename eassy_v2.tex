...
\begin{abstract}
We investigate the queen lattice gas---a model in which $N$ queens
...
$[1.944\,000\,75,\;1.944\,001\,08]$---a precision of ${\sim}\,3
...
problem in a queen lattice gas with tunable
temperature~\cite{Zhang2009,Polson2024} and perform extensive Monte
Carlo simulations.  A central finding is that the specific heat per
