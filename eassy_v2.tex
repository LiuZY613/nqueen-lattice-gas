...
Monte Carlo data, providing a \emph{physical} determination
...
This provides a \emph{physical} route to $\gamma$,
...
$n$-queens lattice gas through extensive Monte Carlo simulations.
...
These results establish the $n$-queens lattice gas as a model system
