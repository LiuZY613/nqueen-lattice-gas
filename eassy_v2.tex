...
point for $N = 8$--$512$ reveal that the specific heat per queen
...
$\gamma_{\rm MC} = 1.93$ at $N = 512$, within $0.67\%$ of the
...
that have dominated to date~\cite{Simkin2022}.  Our thermodynamic extraction yields $\gamma_{\rm MC} = 1.93$ at
$N = 512$ (within $0.67\%$ of the precise value~\cite{Nobel2023}), demonstrating
...
We simulate seven system sizes $N = 8, 16, 32, 64, 128, 256, 512$
...
All seven sizes share the identical temperature grid and measurement
...
$T^* \approx 0.24\,J$, reaching $\tau_{\rm int} \approx 4.9 \times
10^4$ sweeps for $N = 512$.  Even at this worst case, $10^8$
...
\begin{figure}[t]
  ...
  as a function of temperature for $N = 8$--$512$.  The rate drops
...
Figure~\ref{fig:energy} shows $E/N$ vs.\ $T$ for $N = 8$--$256$.
...
\begin{figure}[t]
  ...
  $N = 8$--$256$.  (a)~Logarithmic temperature scale over the full
...
$\gamma_{\rm MC} = 1.83$ ($N = 32$), $1.88$ ($N = 64$),
$1.91$ ($N = 128$), $1.93$ ($N = 256$),
and $1.93$ ($N = 512$), with the deviation
decreasing from $5.7\%$ to $0.67\%$ at $N = 512$.
...
\begin{table}[t]
  ...
  \begin{tabular}{cD{.}{.}{3}D{.}{.}{3}D{.}{.}{3}c}
    ...
    \hline
    512 & 4.308 & \multicolumn{1}{c}{---} & 1.931 & 0.67\% \\
  \end{tabular}
  \end{ruledtabular}
\end{table}
...
\begin{figure}[t]
  ...
  $N = 128$ and $N = 256$ MC data are shown, as these are closest to
...
\item Thermodynamic integration of $C_v/T$ recovers the ground-state
  ...
  to $\gamma = 1.944001$~\cite{Nobel2023}, reaching $1.93$ at $N = 512$ ($0.67\%$
...
sizes ($N \gtrsim 512$), which would yield a more precise
