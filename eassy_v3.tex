...
$N \times N$ lattice, a single particle placed freely in one row \lw{what does this mean ? what is the constraint here ?} has
...
a statistical-mechanical approach.  We embed \lw{embed of map ?} the $N$-queens
...
$N = 1024$ (within $0.1\%$ of the precise value~\cite{Nobel2023}) \lw{try finite size scaling}, demonstrating
...
Section~\ref{sec:conclusions} concludes with a discussion \lw{limitations of} the Monte Carlo and tensor network approaches and the open problems.
...
\label{sec:thermo_int} \lw{what does self-consistency mean here ?}
%=====================================================================
...
simulation can be used to estimate the the
...
offer new results in this acient problem in combinatorics. 
