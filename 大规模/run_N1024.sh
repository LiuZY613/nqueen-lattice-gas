#!/bin/bash
#SBATCH --job-name=nqueen_N1024
#SBATCH --partition=home
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --output=N1024_%j.log
#SBATCH --error=N1024_%j.err

# ============================================================
#  N=1024 Queen Lattice Gas — Thermodynamic Integration
#  Same temperature grid as N=256/512
# ============================================================
...
# Merge
MERGED="data_N1024.dat"
echo "# L=1024 N=1024  Large-scale thermodynamic integration" > "$MERGED"
