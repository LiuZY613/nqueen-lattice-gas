#!/bin/bash
#SBATCH --job-name=nqueen_N256
#SBATCH --partition=home
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --output=N256_%j.log
#SBATCH --error=N256_%j.err

# ============================================================
#  N=256 Queen Lattice Gas — Thermodynamic Integration
#  Same temperature grid as N=512
# ============================================================
...
echo "=========================================="
echo "  N=256 Simulation — $(date)"
echo "=========================================="

gcc -O3 -o mc_canonical_256 mc_canonical.c -lm -Wall
echo "Compiled."
...
# Merge
MERGED="data_N256.dat"
echo "# L=256 N=256  Large-scale thermodynamic integration" > "$MERGED"
